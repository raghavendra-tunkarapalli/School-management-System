...
public class ClassScheduleEntity {
    ...
    public ClassScheduleEntity(Integer classStandard, Integer sectionId, Integer periodIndex, String timingLabel, String roomNo, String teacherName, String subjectName, String scheduleDate) {
        this.classCode = "CLS_" + classStandard + "_SEC_" + sectionId;
    ...
    public ClassScheduleEntity(String classCode, Integer classStandard, Integer sectionId, Integer periodIndex, String timingLabel, String roomNo, String teacherName, String subjectName, String scheduleDate) {
