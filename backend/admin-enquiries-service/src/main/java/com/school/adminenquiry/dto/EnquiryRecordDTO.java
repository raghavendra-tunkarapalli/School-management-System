package com.school.adminenquiry.dto;
...
public class EnquiryRecordDTO {
    ...
    public EnquiryRecordDTO() {
    }

    public EnquiryRecordDTO(Long id, String enquireId, String firstName, String lastName, String email, String parentName, String parentEmail, String childName, String className, String enquire, String adminResponse, String applicantType, String status, String createdAt) {
        this.id = id;
