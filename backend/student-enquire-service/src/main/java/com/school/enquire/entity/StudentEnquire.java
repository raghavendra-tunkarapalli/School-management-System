...
public class StudentEnquire {
    ...
    public StudentEnquire() {
    }

    public StudentEnquire(String enquireId, String firstName, String lastName, String email, String parentName, String parentEmail, String childName, String className, String enquire) {
